...
// Human-readable labels for statuses and categories live in src/i18n (status.* / category.*).

export const STATUS = {
  submitted:    { badge: 'bg-slate-100 text-slate-700 ring-slate-300',   bar: 'bg-slate-400',   dot: 'bg-slate-400', solid: 'bg-slate-600 text-white border-slate-600' },
  acknowledged: { badge: 'bg-sky-50 text-sky-800 ring-sky-200',          bar: 'bg-sky-500',     dot: 'bg-sky-500', solid: 'bg-sky-600 text-white border-sky-600' },
  in_progress:  { badge: 'bg-amber-50 text-amber-800 ring-amber-200',    bar: 'bg-amber-500',   dot: 'bg-amber-500', solid: 'bg-amber-500 text-white border-amber-500' },
  resolved:     { badge: 'bg-emerald-50 text-emerald-800 ring-emerald-200', bar: 'bg-emerald-500', dot: 'bg-emerald-500', solid: 'bg-emerald-600 text-white border-emerald-600' },
...
// The texts live in the dictionaries as reject.suggestion.<key>.
export const REJECTION_SUGGESTIONS = ['duplicate', 'jurisdiction', 'details', 'resolved', 'notCivic'];
